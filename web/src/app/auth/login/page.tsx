import { login, signup, signInWithGoogle, signInWithApple, signUpWithPhone } from './actions'
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50">
       <div className="max-w-md w-full p-8 bg-white rounded-xl shadow-lg border border-slate-100">
          ...
          <form className="space-y-4 mb-6">
            ...
            <button formAction={signUpWithPhone} className="w-full py-2.5 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-lg transition shadow-sm hover:shadow">
